...
colorbar
title('Desvio (Método de Gauss-Seidel)')
xlabel('n')
ylabel('k')
...
axis([0 L 0 T0])
title('Perfil de Temperatura (Método de Gauss-Seidel)')
...
colorbar
title('Solução Analítica vs Solução Numérica (Método de Gauss-Seidel)')
xlabel('Distância, x(m)')
ylabel('Tempo, t(s)')
